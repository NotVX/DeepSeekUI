...
function MenuUI:_CreateSlider(text, minValue, maxValue, initialValue, callback, parent)
	...
	local function updateSlider(value)
		...
		label.Text = text .. ": " .. math.floor(sliderValue)
...
function MenuUI:AddSlider(menuId, text, minValue, maxValue, initialValue, callback)
	local menu = self._menus[menuId]
	if not menu then return end
	
	local slider = self:_CreateSlider(text, minValue, maxValue, initialValue, callback, menu.Container)
